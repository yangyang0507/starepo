  ...
  return (
    <div className={cn("space-y-5", className)}>
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <div className="relative">
            <input
              ...
              className={cn(
                "bg-background w-full rounded-md border px-3 py-2 text-sm pr-10",
        ...
        <div className="bg-muted/50 space-y-3 rounded-lg p-3.5 text-left text-sm">
          <h3 className="text-sm font-medium">
            如何获取 Personal Access Token：
          </h3>
          <ol className="list-inside list-decimal space-y-1.5 text-xs text-muted-foreground leading-relaxed">
          ...
          <div className="rounded border border-amber-200 bg-amber-50 p-2.5 text-xs text-amber-700 dark:border-amber-800 dark:bg-amber-950/20 dark:text-amber-300">
            <h4 className="mb-1.5 font-medium text-amber-800 dark:text-amber-200">所需权限范围：</h4>
