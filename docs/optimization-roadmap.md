...
- [ ] 更新 ESLint 配置支持 React 17+ JSX Transform
- [ ] 修复所有 `'React' must be in scope when using JSX` 错误
- [ ] 配置自动导入规则

#### 1.2 TypeScript any 类型替换
- [ ] 修复主进程中的 any 类型 (5处)
- [ ] 修复渲染进程服务中的 any 类型 (15处)
- [ ] 修复 UI 组件中的 any 类型 (8处)
...
**预期结果**: ESLint 错误数量从 280 降至 0

### 2. 关键 Bug 修复
- [ ] 修复 React Compiler 警告 (`sidebar.tsx:84`)
- [ ] 修复 case 声明问题 (`timeline-chart.tsx:68`)
- [ ] 修复 require() 导入问题
